export const commbankDotEthAbi = [
  {
    inputs: [
      { internalType: "address", name: "_noteVerifier", type: "address" },
      { internalType: "address", name: "_transactVerifier", type: "address" },
      { internalType: "address", name: "_withdrawalVerifier", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "_hasher", type: "address" }],
    name: "setPoseidon",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
