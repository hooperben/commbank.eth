...
In order to most efficiency index commbank.eth private transfers, an indexer is deployed. This indexer tracks all state changes, and makes sent notes accessible in a much more workable manner.
...
The ability to decentralise by adding/modifying indexers based on user preference is in the backlog.
